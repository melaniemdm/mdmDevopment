    ...
    <div className="portfolio-container">
      <div className="hero">
        ...
        <div className="hero--bio">
          ...
          <p className="basic-info">Je suis developpeur front end en javaScript-Reactet je suis passionnée par la création et la modication de sites vitrines. J'ai l'avantage via la freelance de pouvoir travailler dans toute la France afin de réaliser vos projets de sites vitrines.</p>
          <nav>
